$(document).ready(function () {
    ...
    $("#calcular").click(function () {
        ...
        var sb10Txt = "10 Usuarios Concurrentes";
        ...
        if ($("#empleados").val() >= 1 & $("#empleados").val() <= 10) {
            ...
            $("#inversion").html("$" + Number(sb10Precio).toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")).append(" Pesos IVA Incluido");
            ...
            $("#benAnual").html("$" + Number(benAnual).toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")).append(" Pesos IVA Incluido");
        } else {
            if ($("#empleados").val() >= 11 & $("#empleados").val() <= 25) {
                $("#solucion").html(sb25Txt);
                $("#inversion").html("$" + Number(sb25Precio).toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")).append(" Pesos IVA Incluido");
                ...
                if ($("#empleados").val() >= 26 & $("#empleados").val() <= 50) {
                    ...
                    $("#inversion").html("$" + Number(sb50Precio).toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")).append(" Pesos IVA Incluido");
                    ...
                    if ($("#empleados").val() >= 51 & $("#empleados").val() <= 75) {
                        ...
                        $("#inversion").html("$" + Number(sb75Precio).toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")).append(" Pesos IVA Incluido");
                        ...
                        if ($("#empleados").val() >= 76 & $("#empleados").val() <= 100) {
                            ...
                            $("#inversion").html("$" + Number(sb100Precio).toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")).append(" Pesos IVA Incluido");

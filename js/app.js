...
$(document).ready(function () {
    ...
    document.getElementById("numero").onblur = function () {
        ...
        if (!isNaN(parseFloat(this.value.replace(/,/g, "")))) {
            ...
            this.placeholder = parseFloat(11282.00).toFixed(2).toString();
            document.getElementById("salarioMensual").value = 11282.00;
        }
    }

    $("#calcular").click(function () {

        if (isNaN($("#empleados").val()) || isNaN($("#salarioMensual").val())) {

            $("#alertaCero").show();
        } else {
            if ($("#empleados").val() > 0 && $("#salarioMensual").val() > 0) {
                $("#alertaCero").hide();
